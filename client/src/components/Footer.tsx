      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="animate-fade-in-up animate-stagger-1">
            ...
            <h3 className="font-bold text-lg mb-4 hover:text-green-300 transition-colors duration-300">
              Instituto Matriz
            </h3>
            <p className="text-blue-100 text-sm leading-relaxed hover:text-white transition-colors duration-300">
          ...
          <div className="animate-fade-in-up animate-stagger-2">
            <h4 className="font-bold mb-4 hover:text-green-300 transition-colors">Links Rápidos</h4>
          ...
          <div className="animate-fade-in-up animate-stagger-3">
            <h4 className="font-bold mb-4 hover:text-green-300 transition-colors">Serviços</h4>
            <ul className="space-y-2 text-sm text-blue-100">
          ...
          <div className="animate-fade-in-up animate-stagger-4">
            <h4 className="font-bold mb-4 hover:text-green-300 transition-colors">Contato</h4>
